                    ...
                    <div class="col-md-9">
                        <form action="" method="post" class="card UserBox">
                            <div class="card-body d-block">
                                                    ...
                                                    <td>
                                                        <a href="#bookinginfo" data-bs-toggle="modal"
                                                            ...
                                                            <small class="d-block">Time:
                                                                <b>{{ date('H:i A',strtotime($booking->booking_start_time)) }} To
                                                                {{ date('H:i A',strtotime($booking->booking_end_time)) }} </b></small>                                                                    
                                                        </a>
                                                    </td>
                                                    <td>
                                    ...
                                    @endphp
                                        ...
                                        <div class="Tbody">
                                            ...
                                            <div class="cell text-start">
                                                ...
                                                @if ($booking->payment == 1)
                                                    <small class="text-success fw-semibold PaymentS"><i
                                                            class="fad fa-circle"></i> Payment Paid</small>
                                                @endif
                                                @if ($booking->payment == 2)
                                                    <small class="text-danger fw-semibold PaymentS"><i
                                                ...
                                                @if ($booking->payment == 3)
                                                    <small class="text-primary fw-semibold PaymentS"><i
                                                            class="fad fa-circle"></i> Payment by Wallet</small>
                                                @endif
                                            </div>
                                            <div class="cell">
                                                ...
                                                @if ($booking->call_end_by == 0)
                                                    @if ($booking->call_invitation == 1)
                                                        <br><small class="text-success"><i class="fad fa-circle"
                                                            ...
                                                            Received Call Invitation</small>
                                                    @endif
                                                    @if ($booking->call_invitation == 2)
                                                        <br><small class="text-success"><i class="fad fa-circle"
                                            ...
                                            <div class="cell">
                                                ...
                                                <br><small class="text-danger"><i class="fad fa-circle" style="font-size: 8px;"></i> This schedule is out of date </small>
                                                @elseif ($booking->status == 1 && $booking->reschedule_slot == 0)
                                                @php
                                                $currentDateTime = date('Y-m-d H:i');
                                                $bookingStartDateTime = date('Y-m-d H:i', strtotime($booking->booking_date . ' ' . $booking->booking_start_time));
                                                $bookingEndDateTime = date('Y-m-d H:i', strtotime($booking->booking_date . ' ' . $booking->booking_end_time));
                                                @endphp

                                                @if ($bookingStartDateTime <= $currentDateTime && $currentDateTime <= $bookingEndDateTime)
                                                <a href="{{ route('user.videocall', ['schedule' => $booking->booking_id]) }}" target="_blank" class="h5 text-primary">
                                                <span> <button type="button" class="btn btn-success"> <i class="fal fa-video me-1"></i> Join Now</button></span>
                                                </a>
                                                @elseif ($bookingStartDateTime > $currentDateTime)
                                                <span class="SessionLink">
                                                <a href="{{ route('user.videocall', ['schedule' => $booking->booking_id]) }}" target="_blank" class="h5 text-primary disabled">
                                                <span> <button type="button" class="btn btn-success"> <i class="fal fa-video me-1"></i> Join Now</button></span>
                                                </a>
                                                </span>
                                                @endif
                                ...
                                <small><b>NOTE:</b> If you miss any slot by mistake, then you can talk to the administrator on <a href="mailto:{{ mailsupportemail() }}">{{ mailsupportemail() }}</a>.</small>
                            </div>
                        </form>
                    </div>
                </div>
