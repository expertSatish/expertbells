    ...
    <section class="p-0">
        ...
        <div class="row h-100">
            ...
            <div class="col-12">
                        ...
                        <div class="join-right" style="width: 350px">
                            ...
                            <div>
                                <div class="class-control row" style="margin-top: 120px">
                                    <div class="col-8">
                                        <input type="hidden" id="joinMeetingName" value="{{$name}}" placeholder="Name Of Participant" class="form-control" />
                                    </div>
                ...
                <div class="grid-page VideoBox pt-lg-3" id="gridPpage" >
...
section{height:calc(105vh - 63px);overflow:hidden;}
...
.VideoBox .BtnS{width:100%; padding-top: 10px;gap:9px}
