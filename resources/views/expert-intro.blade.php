                    ...
                    <div class="col-lg-3">
                            ...
                            <p class="lh-n"><a href=""
                                    class="text-secondary"><small>{{ count($experts->publishreviews) }} reviews /
                                        {{ count($slotsCount) }}sessions</small></a></p>
                    ...
                    @if($video->video_type == 2)
                        <div class="card">
                            ...
                            <a style="text-align: center;" href="{{ route('experts', ['alias'=>$video->expert->user_id,'type'=>'videos','v'=>$video->video_id,'check'=>Request::segment(2)]) }}" class="card-body">
                                ...
                                <p class="text-secondary me-3"><i class="far fa-user thm"></i>&nbsp;{{ $video->expert->name ?? '' }}</p>
                    ...
                    @else
                     <div class="card">
                        <div style="display: flex; justify-content: center; align-items: center;">
                             ...
                             @php
                            $video = App\Models\ExpertVideo::where('expert_id', $experts->id)->first();
