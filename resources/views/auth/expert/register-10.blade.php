        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-8">
                    ...
                    <form action="{{route('expert.saveregisteration',['step'=>'s10'])}}" method="post" class="card card-body formbox mt-3">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 mb-2">
                                <div class="CustomerInfo" id="s10">
                                    <small class="num text-secondary d-block mb-3 text-center"><span class="thm">10 <i class="fal fa-long-arrow-right"></i></span> Step</small>
                                    <div class="row">
                                        <div class="col-md-9"><h3 class="h5 thm">Tell us about yourself<span class="text-danger">*</span></h3></div>
                                        <div class="col-md-3 text-end"><small class="text-secondary">Max Word : 300</small></div>
                                    </div>
                                    <div class="input-group">
                                        <textarea class="form-control" name="bio" placeholder="Type your answer here...">{{old('bio',expertinfo()->bio)}}</textarea>
                                    ...
                                    <div class="text-center d-flex justify-content-between align-items-center mt-3">
                                        <a href="{{route('expert.register',['type'=>'s9'])}}" class="btn btn-sm formbtn BackToStep sws-top sws-bounce" data-title=""><i class="fal fa-arrow-left me-2"></i> Back</a>
                                        <button class="btn ms-2 px-4 bg-thm checkstep10 formbtn Next sws-bottom" onclick="$('.checkstep10').hide(); $('.p-checkstep10').show();" data-title="Next"> Next <i class="fal fa-arrow-right"></i></button>
                                        <button type="button" class="btn ms-2 px-4 bg-thm p-checkstep10 formbtn Next sws-bottom disabled" style="display:none;" data-title="Next"> <i class="fad fa-spinner-third fa-spin"></i> Loading...</button>
                                    </div>
                                </div>
                            </div>
                        </div>
