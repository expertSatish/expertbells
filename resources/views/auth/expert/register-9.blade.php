        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-8">
                    ...
                    <form action="{{route('expert.saveregisteration',['step'=>'s9'])}}" method="post" class="card card-body formbox mt-3">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 mb-2">
                                <div class="CustomerInfo" id="s9">
                                    <small class="num text-secondary d-block mb-3 text-center"><span class="thm">9 <i class="fal fa-long-arrow-right"></i></span> Step</small>
                                    <h3 class="h5 thm">How many sessions of 30-min, you can take in a week? <span class="text-danger">*</span></h3>
                                    <div class="input-group">
                                        <input type="number" class="form-control" value="{{old('take_session',expertinfo()->take_session)}}" name="take_session" placeholder="Type your answer here...">
                                        <button href="javascript:void(0)" class="btn ms-2 formbtn Next checkstep9 sws-top" onclick="$('.checkstep9').hide(); $('.p-checkstep9').show();" data-title="Next"><i class="fal fa-arrow-right"></i></button>
                                        <button type="button" class="btn ms-2 formbtn Next p-checkstep9 sws-top disabled" style="display:none;" data-title="Next"> <i class="fad fa-spinner-third fa-spin"></i></button>
                                    </div>
                                    @error('take_session') <span class="error">{{$message}}</span> @enderror
                                    
                                    <small class="error name-error"></small>
                                    @error('name')<small class="error">{{$message}}</small>@enderror
                                    <div class="text-center mt-3">
                                        <a href="{{route('expert.register',['type'=>'s8'])}}" class="btn btn-sm formbtn BackToStep sws-top sws-bounce" data-title=""><i class="fal fa-arrow-left me-2"></i> Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
